...
| Linux / Windows | Not supported in v0.5.0 |
...
- New third-party GPT App targets default to `standard-tools`: Standard Responses with the policy-filtered core, allowed-Plugin, and user-MCP surface, without standalone-search advertisement.
