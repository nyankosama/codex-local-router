...
if (state.schemaVersion !== 1 || state.feature !== "universal-search-standard-tool-v1" ||
    !state.prior?.spaceRef || !state.prior?.packagePath || !state.targetId)
  throw Error("invalid universal-search rollback state");
