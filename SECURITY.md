...
Please report vulnerabilities through [GitHub private vulnerability reporting](https://github.com/nyankosama/codex-local-router/security/advisories/new). Do not open a public issue containing credentials, authentication material, private conversation content, encrypted state, or an exploitable proof of concept.
